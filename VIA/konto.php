...
<div class="w3-container w3-top dnbGrey w3-large w3-padding" style="z-index:4">
  <button class="w3-btn w3-hide-large w3-padding-0 w3-hover-text-grey" onclick="w3_open();"><i class="fa fa-bars"></i> Menu</button>
    <a href="logout.php"><div class="w3-right">Logg ut</div></a>
      ...
      <div class="w3-container dnbColor w3-text-white w3-padding-16">
        ...
        <table class="w3-table w3-striped w3-white">
          <tr>
            ...
            <td class="w3-quarter">SPAREKONTO</td>
            <td class="w3-quarter">10 543.00</td>
            <td class="w3-quarter"><a href="DNBsparekonto.php"><div class="button1">Se transaksjoner</div></a></td>          </tr>
            
          <tr>
            <td class="w3-quarter">EKIA</td>
            <td class="w3-quarter">BRUKSKONTO</td>
            <td class="w3-quarter">00 758.69</td>
            <td class="w3-quarter"><div class="button1">Se transaksjoner</div></td>          </tr>
            
          <tr>
            <td class="w3-quarter">EIKA</td>
            <td class="w3-quarter">SPAREKONTO</td>
            <td class="w3-quarter">50 000.00</td>
            <td class="w3-quarter"><div class="button1">Se transaksjoner</div></td>          </tr>
            
          <tr>
            <td class="w3-quarter">DNB</td>
            <td class="w3-quarter">DEPOSITUMSKONTO</td>
            <td class="w3-quarter">30 000.00</td>
            <td class="w3-quarter"><div class="button1">Se transaksjoner</div></td>
          </tr>
          <tr>
            <td class="w3-quarter">Sparebank1</td>
            <td class="w3-quarter">BRUKSKONTO</td>
            <td class="w3-quarter">00 035.05</td>
            <td class="w3-quarter"><div class="button1">Se transaksjoner</div></td>          </tr> 
            <tr>
            <td class="w3-quarter"><div class="button1">+Legg til bankkonto</div></td>          </tr>
        </table>
      </div>
    </div>
  </div>
