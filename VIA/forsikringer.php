  ...
  <A href="konto.php"><div class="w3-row-padding w3-margin-bottom">
    ...
    <a href="budsjett.php"><div class="w3-quarter">
      <div class="w3-container dnbColor w3-text-white w3-padding-16">
          <div class="w3-left"><img src="img/nett_mobil.png" style="height:50px"></img> </div>
        <div class="w3-right">
          <h3>0</h3>
        </div>
        <div class="w3-clear"></div>
        ...
        <table class="w3-table w3-striped w3-white">
          <tr>
            ...
            <td class="w3-quarter">Innboforskiring</td>
            <td class="w3-quarter"><div class="button1">Se forsikringsvilkår</div></td>          </tr>
            
          <tr>
            <td class="w3-quarter">EKIA</td>
            <td class="w3-quarter">Bilforsikring</td>
            <td class="w3-quarter"><div class="button1">Se forsikringsvilkår</div></td>          </tr>
                 
          <tr>
            <td class="w3-quarter">DNB</td>
            <td class="w3-quarter">Reiseforsikring</td>
            <td class="w3-quarter"><div class="button1">Se forsikringsvilkår</div></td>
          </tr>
                        <tr>
            <td class="w3-quarter"><div class="button1">+Legg til forsikring</div></td>          </tr>
        </table>
      </div>
    </div>
  </div>
